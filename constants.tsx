...
export const PROJECTS: Project[] = [
  {
    ...
    image: "/Projects%20Thumbnails/Zentrix.png",
  ...
  },
  {
    ...
    image: "/Projects%20Thumbnails/vapetrax.png",
  ...
  },
  {
    ...
    image: "/Projects%20Thumbnails/MedTime.png",
  ...
  },
  {
    ...
    image: "/Projects%20Thumbnails/PlutoRunner.png",
  ...
  },
  {
    ...
    image: "/Projects%20Thumbnails/GlobalIntel.png",
  ...
  },
  {
    ...
    image: "/Projects%20Thumbnails/Visionary%20AI.png",
  ...
  {
    id: "nexus-erp",
    title: "Nexus ERP — Enterprise Resource Planner",
    description: "A comprehensive internal management tool for tracking manufacturing supply chains and employee HR workflows.",
    image: "https://picsum.photos/seed/nexus/800/600",
    tags: ["SaaS", "Enterprise", "B2B", "Dashboard"],
    techStack: ["React", "PostgreSQL", "Node.js", "Prisma"],
    links: { demo: "#", github: "#" },
  },
  {
    id: "echo-ai",
    title: "Echo AI — Voice Assistant Platform",
    description: "A voice-first AI platform that allows brands to build custom voice agents for customer support and lead generation.",
    image: "https://picsum.photos/seed/echoai/800/600",
    tags: ["AI", "Voice", "Automation"],
    techStack: ["Next.js", "OpenAI", "WebRTC"],
    links: { demo: "#", github: "#" },
  },
  {
    id: "quantum-learn",
    title: "Quantum Learn LMS",
    description: "A digital learning management system enabling creators to monetize their video courses with secure DRM and drip content.",
    image: "https://picsum.photos/seed/quantum/800/600",
    tags: ["EdTech", "Creator Economy", "Video"],
    techStack: ["React", "Mux API", "Stripe", "Supabase"],
    links: { demo: "#", github: "#" },
  },
  {
    id: "zenith-commerce",
    title: "Zenith E-Commerce Core",
    description: "A high-conversion headless e-commerce storefront utilizing Shopify's Storefront API and highly unopinionated styling.",
    image: "https://picsum.photos/seed/zenith/800/600",
    tags: ["E-Commerce", "Headless", "Retail"],
    techStack: ["Next.js", "Shopify GraphQL", "Tailwind CSS"],
    links: { demo: "#", github: "#" },
  },
  {
    id: "omni-health",
    title: "OmniHealth Patient Portal",
    description: "A HIPAA-compliant medical portal allowing patients to securely book appointments and access their lab results.",
    image: "https://picsum.photos/seed/omni/800/600",
    tags: ["HealthTech", "Security", "Portal"],
    techStack: ["React Native", "TypeScript", "Node.js"],
    links: { demo: "#", github: "#" },
  },
  {
    id: "solstice-analytics",
    title: "Solstice Analytics",
    description: "A financial data visualization tool providing retail investors with algorithmic stock trend predictions and custom alerts.",
    image: "https://picsum.photos/seed/solstice/800/600",
    tags: ["FinTech", "Data Science", "Visualization"],
  ...
  },
  {
    id: "horizon-crm",
    title: "Horizon CRM",
    description: "A lightweight, massively scalable CRM aimed at small service businesses to track invoices, quotes, and client follow-ups.",
    image: "https://picsum.photos/seed/horizon/800/600",
    tags: ["CRM", "SaaS", "Business"],
